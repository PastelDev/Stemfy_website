...
const I18N = {
  ...
  en: {
    ...
    tutorial_damping_title: 'Damping',
    tutorial_damping_text: 'Enable damping to model friction or air resistance. Higher values remove energy faster, so the motion settles.',
  ...
  el: {
    ...
    tutorial_damping_title: 'Απόσβεση',
    tutorial_damping_text: 'Ενεργοποίησε την απόσβεση για να προσομοιώσεις τριβή ή αντίσταση αέρα. Με μεγαλύτερη τιμή η ενέργεια χάνεται πιο γρήγορα και η κίνηση σβήνει.',
